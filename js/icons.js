/**
 * icons.js — jeu d'icônes SVG inline (style outline façon Lucide).
 * SVG inline = pas de requête réseau, léger, colorable via currentColor.
 * Remplaçables par des assets définitifs en Phase 3.
 */
const PATHS = {
  folder:
...
/**
 * Retourne le markup SVG d'une icône.
 * @param {string} name - clé dans PATHS
